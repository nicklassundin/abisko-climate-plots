...
var meta_struct = {
	...
	set: undefined,
	monthly: undefined,
	create: function(config, lang, data, set, monthly){
		var res = this.clone();
		res.config = config;
		res.lang = lang;
		res.monthly = monthly;
...
var config = {
	...
	abisko: dataset_struct.create(
		...
		meta = {
			'temperatures': {
				...
				'monthlySlide': meta_struct.create(config =  'temperature', lang =  'monthlyTemperature', data =  'ANS', set = 'slide',  monthly =  true)
			},
			'precipitation':{
				...
				'monthly': meta_struct.create(config =  'precipitation', lang =  'monthlyPrecipitation', data =  'ANS', set = 'weather', monthly =  true),
				...
				'monthlySlide': meta_struct.create(config =  'precipitation', lang =  'monthlyPrecipitation', data =  'ANS', set = 'slide', monthly =  true), 
			},
			'growingSeason': meta_struct.create(config =  'growingSeason', lang =  'growingSeason', data =  'ANS', set =  'slide'), 
			'growingSeasonDays': meta_struct.create(config =  'growingSeason', lang =  'growingSeasonDays', data =  'ANS', set =  'slide'), 
			'growingSeasonFrostFirst': meta_struct.create(config =  'growingSeasonFirst', lang =  'growingSeasonFrostFirst', data =  'ANS', set =  'slide'), 
			'growingSeasonFrostLast': meta_struct.create(config =  'growingSeasonLast', lang =  'growingSeasonFrostLast', data =  'ANS', set =  'slide'), 
	...
	permaHistogramCALM: dataset_struct.create(
		...
		parser = parse.CALM,
		meta = meta_struct.create(config =  'perma', lang =  'perma', data =  undefined, set =  'weather' ),
		reader = Papa.parse,
		local = false),
